...
$stmt = $con->stmt_init();
	...
	<div align="center" >
	<p style="font-size:28px;">Select your Preferred Car and Location to locate your dealer</p>
	<form id="dsform" method="post" action="">
		...
		<input type="submit" name="submit" class="searchimgclass"  id="dssubmit" value="">
	</form>
...
EOPAGE;
	...
	<div class="mainbox">
			<div  class="dscontainer">
		<p align='center' style="font-size:30px;padding-top:5em;">Your Details has been sent to the dealer. You will be contacted soon...</p>
	</div></div>
EOPAGE;
	...
	{	 
	$pagecontents .= <<< EOPAGE
	<p style="font-size:24px;">Displaying $brand car dealers in $loc</p>
	<div style="overflow:auto; height:350pt;">
...
EOPAGE;
	...
	else
	{
		...
		$pagecontents .= <<< EOPAGE
	<div style="overflow:auto; height:350pt;">
		<p style="font-size:24px;">No dealers found for $brand cars in $loc</p>
...
EOPAGE;
	...
	$pagecontents .= <<< EOPAGE
		...
		<div id="popup_content"> <!--your content start-->
			...
			<p style="font-size:20;font-weight:bold">Send your details to the dealer..</p><br>
		<form id="custform" name="custform" action="" method="post">
		<table class="custtable">
		<tr><td><input placeholder="Name" type="text" id="custname" name="name" style="width:200px;height:20px"></td></tr>
		
		<tr><td><input placeholder="Email" type="text" id="custemail" name="email" style="width:200px;height:20px"></td></tr>
		<tr><td><input placeholder="Phone Number" type="text" id="custphno" name="phno" style="width:200px;height:20px"></td></tr>
		<tr><td>
